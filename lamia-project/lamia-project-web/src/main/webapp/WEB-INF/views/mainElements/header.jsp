...
<body>
    ...
    <core:if test="${Autorization != true}">
		...
		<div id="wrap"></div>
		<div id="window">
			<spring:form id="autorization-form" action="Autorization" method="POST" modelAttribute="UserFromJspAutorization">
			...
			<spring:form id="registration-form" action="Registration" method="POST" modelAttribute="UserFromJspRegistration">
				<label class="autorization-label content-registration">Регистрация </label> 
				<spring:input path="login" id="registration-login" name="registration-login" class="content-registration" placeholder="Введите логин"/>
				<spring:input path="password" id="registration-password" name="registration-password" type="password" class="content-registration" placeholder="Введите пароль"/>
				<spring:input path="repeatPassword" id="registration-second-password" name="registration-second-password" type="password" class="content-registration" placeholder="Повторите пароль"/>
				<spring:input path="email" id="registration-email" name="registration-email" type="email" class="content-registration" placeholder="Введите e-mail"/>
